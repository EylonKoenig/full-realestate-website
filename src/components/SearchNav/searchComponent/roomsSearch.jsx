        ...
        return (
            <div className="dropdown-menu inside-beds-search inside-search-button " aria-labelledby="dropdownMenuButton">
                ...
                <div className="filter-btn-group">
                    ...
                    <input id="Baths-1-desktop" className={'checkButton'} name="minRooms" type="radio" value="1"
                        onChange={handleInputChange} />
                    <label htmlFor="Baths-1-desktop">1+</label>

                    <input id="Baths-2-desktop" className={'checkButton'} name="minRooms" type="radio" value="2"
                        onChange={handleInputChange} />
                    <label htmlFor="Baths-2-desktop">2+</label>

                    <input id="Baths-3-desktop" className={'checkButton'} name="minRooms" type="radio" value="3"
                        onChange={handleInputChange} />
                    <label htmlFor="Baths-3-desktop">3+</label>

                    <input id="Baths-4-desktop" className={'checkButton'} name="minRooms" type="radio" value="4"
                        onChange={handleInputChange} />
                    <label htmlFor="Baths-4-desktop">4+</label>

                    <input id="Baths-5-desktop" className={'checkButton'} name="minRooms" type="radio" value="5"
                        onChange={handleInputChange} />
