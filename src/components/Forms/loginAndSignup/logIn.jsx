                    ...
                    <div className="myform form ">
                        ...
                        <form action="" method="post" name="login" onSubmit={this.handleSubmit}>
                            <div className="form-group">
                                ...
                                <input type="email" name="user"  class="form-control" id="email" aria-describedby="emailHelp" placeholder="Enter email" onBlur={this.inputChange}/>
                                <InputErrors errors={this.state.user.errors}></InputErrors>
                            </div>
                            <div className="form-group">
                                <label for="exampleInputEmail1">Password</label>
                                <input type="password" name="password" id="password"  class="form-control" aria-describedby="emailHelp" placeholder="Enter Password" onBlur={this.inputChange}/>
