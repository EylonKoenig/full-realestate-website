...
class ImageForm extends React.Component {
    ...
    componentDidMount() {
        ...
        if (image) {
            ...
            if (typeof (image) == "string") {
                output.src = "http://shielded-savannah-89374.herokuapp.com/" + image
            }
            else {
    ...
    handelDelete = async () => {
        ...
        if (deleteImage) {
            var output = document.getElementById(`image-preview-File${this.props.index}`);
            output.src = 'http://shielded-savannah-89374.herokuapp.com/images/general/loadingApartment.jpg'
        }
        ...
        return (
            <Form.Row>
                <Form.Group as={Col} style={{ height: "150px" }}>
                    <img className={'image-preview'} id={`image-preview-File${this.props.index}`} src="http://shielded-savannah-89374.herokuapp.com/images/general/loadingApartment.jpg" alt='' />
